...
export class ImageService {
    ...
    static async readAsPath(image_id, thumb = false) {
    ...
    static async removeOwner(image_id, owner_id) {
        const imageModel = await ImageRepo.getOneById(image_id)
        imageModel.owners = imageModel.owners.filter((id) => id != owner_id)
        if (imageModel.owners.length) {
